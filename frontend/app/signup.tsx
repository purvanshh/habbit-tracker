...
export default function SignupScreen() {
    ...
    const handleSignup = async () => {
        ...
        if (error) {
            ...
            // Session exists, auto-login will happen via layout
        } else if (data.user && !data.session) {
            Alert.alert('Success', 'Account created! Please check your email to confirm your account before logging in.');
    ...
    return (
        ...
        >
            <ScrollView
                contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', paddingTop: insets.top, paddingHorizontal: 24, paddingBottom: 20 }}
